                        ...
                        <table id="myTable" style="margin:20px auto;" class="table table-striped table_radius">
                            ...
                            <tr>
                                ...
                                <td style="display:flex; align-item:center; justify-content:center;">
                                    @if($t->status == 'Proses')
                                    <a href="/admin/pengaduan/detail/{{ $t->id_pengajuan }}" style="text-decoration:none">
                                    @endif 
                                    ...
                                    <a href="/admin/delpengaduan/{{ $t->id_pengajuan }}" onclick="return confirm('Apa Anda yakin menghapus id tanggapan {{ $t->id_tanggapan }}?')" style="text-decoration:none">
