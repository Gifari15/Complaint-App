            ...
            <div class="konten">
                <div class="sidebar">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link margin_menu bgmenu_active" href="/petugas/masyarakat">
                        ...
                        <table id="myTable" style="margin:20px auto;" class="table table-striped table_radius">
                            ...
                            <tr>
                                ...
                                <td style="display:flex; align-item:center; justify-content:center;">
                                    ...
                                    <a href="/petugas/delmasyarakat/{{ $m->nik }}" onclick="return confirm('Apa Anda yakin menghapus user {{ $m->nama }}?')" style="text-decoration:none">
                            ...
                            <div class="modal fade" id="modalEditm{{ $m->nik }}" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <a href="/petugas/masyarakat">
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </a>
                                    </div>
                                    <!-- Ini adalah Bagian Body Modal -->
                                    <form method="post" action="/petugas/updatemasyarakat/{{ $m->nik }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="text" id="telpp" name="telpp" class="form-control" placeholder="Masukkan no telepon" value="{{ $m->telp }}" required />
                                    </div>
                                    
                                    <!-- Ini adalah Bagian Footer Modal -->
                                    <div class="modal-footer">
                                        
                                        <a href="/petugas/masyarakat" class="btn btn-outline-danger" style="border-width:2px;">Close</a>
                                        <!-- </button> -->
