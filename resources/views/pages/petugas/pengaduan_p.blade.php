            ...
            <div class="konten">
                <div class="sidebar">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link margin_menu bgmenu_active" href="/petugas/pengaduan">
                        ...
                        <table id="myTable" style="margin:20px auto;" class="table table-striped table_radius">
                            ...
                            <tr>
                                ...
                                <td style="display:flex; align-item:center; justify-content:center;">
                                    @if($t->status == 'Proses')
                                    <a href="/petugas/pengaduan/detail/{{ $t->id_pengajuan }}" style="text-decoration:none">
                                    @endif 
                                    ...
                                    <a href="/petugas/delpengaduan/{{ $t->id_pengajuan }}" onclick="return confirm('Apa Anda yakin menghapus id tanggapan {{ $t->id_tanggapan }}?')" style="text-decoration:none">
