                        ...
                        <div class="bottom_body_content_in_scroll">
                            ...
                            {{ csrf_field() }}
                                ...
                                <img width="" height="180px" style="max-widh:250px;" src="../../../Gambar/{{ $pengaduann->foto }}">
                                    ...
                                    <textarea id="tanggapan" name = "tanggapan" rows="10" cols="50" onKeyPress class="form-control txarea_detail txarea_tanggapan" style="height:190px; border-width:2px; border-color:black;" placeholder="Beri Tanggapan" required readonly></textarea>
                                    </div>
