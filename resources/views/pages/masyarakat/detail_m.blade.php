            ...
            <div class="konten">
                ...
                <div class="container_content">
                    ...
                    <div class="bottom_body_content_out">
                        <div class="bottom_body_content_in_scroll">
                            <form method="post" action="/petugas/tanggapan/add">
                            {{ csrf_field() }}
                                ...
                                <img width="" height="180px" style="max-widh:250px;" src="../../../Gambar/{{ $pengaduann->foto }}">
                                    ...
                                    @if($tanggapann->tanggapan)
                                    <textarea id="tanggapan" name = "tanggapan" rows="10" cols="50" onKeyPress class="form-control txarea_detail txarea_tanggapan" style="height:190px; border-width:2px; border-color:black;" placeholder="Beri Tanggapan" required readonly>{{ $tanggapann->tanggapan}}</textarea>
                                    @endif 
                                    </div>
                                    <!-- <img width="250px" src="{{ url('Gambar/1679243500_2.png') }}"> -->
                                    <!-- <img width="" height="200px" style="max-widh:250px;" src="../../../Gambar/{{ $pengaduann->foto }}"> -->
                            </form>
                        </div>
                    </div>
                </div>
